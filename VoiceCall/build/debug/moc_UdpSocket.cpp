...
QT_MOC_LITERAL(1, 10, 12), // "voiceReceive"
QT_MOC_LITERAL(2, 23, 0) // ""

    },
    "UdpSocket\0voiceReceive\0"
};
...
void UdpSocket::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->voiceReceive((*reinterpret_cast< QByteArray(*)>(_a[1]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (UdpSocket::*)(QByteArray );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&UdpSocket::voiceReceive)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void UdpSocket::voiceReceive(QByteArray _t1)
{
